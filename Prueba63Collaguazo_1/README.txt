...
a persistence unit "Prueba63Collaguazo_1PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Prueba63Collaguazo_1/pom.xml":
...
artifact ("Prueba63Collaguazo_1.war") is already built. You can build
